...
*/
    ...
    public Cursor getdessertIng() {
        Cursor cursor = getReadableDatabase().rawQuery("select * from ingredients where ingredients_cat_id = 7", null);
        return cursor;
    }
    public Cursor getdimsimrec() {
        Cursor cursor = getReadableDatabase().rawQuery("select * from recipes where _id = 1", null);
        return cursor;
    }
    public Cursor getcurryrec() {
        Cursor cursor = getReadableDatabase().rawQuery("select * from recipes where _id = 2", null);
        return cursor;
    }
    public Cursor getcheesypotatorec() {
        Cursor cursor = getReadableDatabase().rawQuery("select * from recipes where _id = 3", null);
        return cursor;
    }
    public Cursor getpastarec() {
        Cursor cursor = getReadableDatabase().rawQuery("select * from recipes where _id = 4", null);
        return cursor;
    }
    public Cursor getnachosrec() {
        Cursor cursor = getReadableDatabase().rawQuery("select * from recipes where _id = 5", null);
        return cursor;
    }
}
